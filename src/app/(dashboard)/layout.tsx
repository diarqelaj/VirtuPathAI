...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-screen text-white">
      {/* TOPBAR */}
      <header className="fixed top-0 left-0 right-0 h-16 z-50 px-6 flex items-center justify-between border-b border-white/10  bg-white/10 backdrop-saturate-150">
      ...
      <div className="flex pt-16 flex-1 overflow-hidden">
        ...
        <aside
          className={`hidden sm:flex ${
            isOpen ? 'w-64' : 'w-20'
          } h-full border-r border-white/10 bg-white/10 backdrop-saturate-150 shadow-md flex flex-col justify-between py-6 px-4 transition-all duration-300`}
          >
