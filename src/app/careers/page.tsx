...
const Page = () => {
  ...
  const SkeletonCard = () => (
    <div className="bg-[#10101a] border border-gray-800 rounded-2xl shadow-sm p-4 animate-pulse flex flex-col min-h-[520px]">
              ...
              : careerPaths.map((career) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-[#10101a] border border-gray-800 rounded-2xl shadow-sm hover:shadow-lg transition-all p-4 group flex flex-col min-h-[520px]"
                    >
                      ...
                      <div className="flex flex-col gap-2 text-left flex-grow">
                        ...
                        <div className="mt-auto pt-3 border-t border-gray-800 text-sm space-y-3">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <button
                              onClick={() =>
                                router.push(`/payment?careerId=${career.careerPathID}`)
                              }
