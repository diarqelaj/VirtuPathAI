...
const CareersPage = () => {
  ...
  <div className="pt-55 px-4 md:px-6 flex-grow"> {/* Increased top padding */}
    ...
    <div className="relative z-10 text-center max-w-6xl mx-auto">
      ...
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
        {careers.map((program) => (
          <div
            key={program.id}
            className="bg-[#1a1b2f] p-6 rounded-xl shadow-lg border border-gray-800 hover:scale-[1.03] transition-transform duration-200"
          >
